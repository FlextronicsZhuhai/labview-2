...
// logout system
String action = StringUtils.get(request.getParameter("action"),"");
...
#inputs input {
	background: #f1f1f1
		url(${ctx}/admin/themes/default/images/login-sprite.png) no-repeat;
	...
	<form id="login" action="msg.jsp" method="post">
		...
		<fieldset id="inputs">
			<input id="username" name="username" type="text" placeholder="我的帐号"
				autofocus required> <input id="password" name="password"
				type="password" placeholder="密码" required>
		</fieldset>
		<fieldset id="actions">
			<input type="hidden" id="return" name="return" value=""> <input
				type="submit" id="submit" value="登 录">
				 <!-- <a href="https://auth.pconline.com.cn/security-server/mailpassword.jsp">忘记密码?</a> -->
		</fieldset>
	</form>
</body>
</html>
